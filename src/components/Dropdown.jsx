  ...
  return (
    <div className="md:hidden flex flex-col gap-4 bg-[#150E28] fixed top-0 right-0 w-full h-full animate-open-menu px-4 z-50 overflow-hidden">
        ...
        <nav className="flex flex-col gap-4 mt-16 items-start">
            <ul><li className="text-white cursor-pointer hover:font-bold font-montserrat">Timeline</li></ul>
            <ul><li className="text-white cursor-pointer hover:font-bold  font-montserrat">Overview</li></ul>
            <ul><li className="text-white cursor-pointer hover:font-bold  font-montserrat">FAQs</li></ul>
            <ul><li className='text-white font-montserrat hover:font-bold cursor-pointer'><Link to='/contact'>Contact</Link></li>
            </ul>
        </nav>
        <Link to='/register'>
